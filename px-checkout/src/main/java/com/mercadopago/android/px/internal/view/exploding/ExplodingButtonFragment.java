...
public class ExplodingButtonFragment extends Fragment {

    public static final String TAG = ExplodingButtonFragment.class.getSimpleName();
    public static final String START_Y_KEY = "start_y";
    ...
    private ExplodingButtonListener listener;
    private int startY;
    ...
    private final AnimatorListenerAdapter resultAnimFinishListener = new AnimatorListenerAdapter() {
        @Override
    ...
    public void onCreate(@Nullable final Bundle savedInstanceState) {
        ...
        if (args != null) {
            startY = args.getInt(START_Y_KEY, 0);
            //TODO check text
...
//        int color = ContextCompat.getColor(getContext(), viewStylingParams.getDarkPrimaryColor());
    ...
    private void createCircularReveal() {
        ...
        int startRadius = getResources().getDimensionPixelOffset(R.dimen.px_m_height) / 2;
    ...
    private void setListener(Context context) {
        if (context == null || context instanceof ExplodingButtonListener) {
            listener = (ExplodingButtonListener) context;
    ...
    public interface ExplodingButtonListener {
        /**
         * Callback to notify that this view has finished the loading animation
         */
        void onLoadingAnimFinished(boolean success, @NonNull ViewStylingParams stylingParams);
    }
}
